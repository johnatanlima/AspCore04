...
{
    public class PatrocinadorEventosController : Controller
    {
        ...
        // GET: PatrocinadorEventos/Details/5
        ...
        // GET: PatrocinadorEventos/Create
        public IActionResult Create()
        {
            ViewData["EventoId"] = new SelectList(_context.Eventos, "EventoId", "BannerUrl");
            ViewData["PatrocinadorId"] = new SelectList(_context.Patrocinadores, "PatrocinadorId", "Nome");
            return View();
        }

        // POST: PatrocinadorEventos/Create
        ...
        public async Task<IActionResult> Create([Bind("PatrocinadorValorId,ValorPatrocinado,EventoId,PatrocinadorId")] PatrocinadorEvento patrocinadorEvento)
        {
            ...
            ViewData["EventoId"] = new SelectList(_context.Eventos, "EventoId", "BannerUrl", patrocinadorEvento.EventoId);
            ViewData["PatrocinadorId"] = new SelectList(_context.Patrocinadores, "PatrocinadorId", "Nome", patrocinadorEvento.PatrocinadorId);
            return View(patrocinadorEvento);
        }

        // GET: PatrocinadorEventos/Edit/5
        ...
        // POST: PatrocinadorEventos/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PatrocinadorEventos/Delete/5
        ...
        // POST: PatrocinadorEventos/Delete/5
